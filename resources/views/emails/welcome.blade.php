...
<head>
    ...
    <title>Bienvenido a {{ config('app.name', 'Quiniela Inoxsa') }}</title>
</head>
<body style="margin:0; padding:0; background-color:#f1f3f7; font-family: Arial, Helvetica, sans-serif; color:#101820;">
    ...
    <div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
        ¡Te damos la bienvenida a la Quiniela Inoxsa! Aquí tienes todo lo que necesitas para empezar.
    </div>
                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 6px 24px rgba(16,24,32,0.08);">
                    ...
                    <tr>
                        <td style="padding:16px 36px 0 36px;">
                            <p style="margin:0; font-size:15px; line-height:1.7; color:#101820;">
                                Tu registro en la Quiniela Inoxsa fue exitoso. Nos alegra contar con tu participación: queremos que esta experiencia sea, sobre todo, una forma divertida y respetuosa de compartir el gusto por el fútbol.
                            </p>
                    ...
                    <tr>
                        <td style="padding:28px 36px 0 36px;">
                            <h2 style="margin:0 0 12px 0; font-size:18px; line-height:1.3; color:#192a77; font-weight:700;">
                                Cómo ingresar
                            </h2>
                                ...
                                <tr>
                                    <td align="center" style="padding:12px 0 0 0;">
                                        <p style="margin:0; font-size:12px; line-height:1.6; word-break:break-all; color:#63666A;">
                                            <a href="{{ $loginUrl }}" target="_blank" style="color:#192a77; text-decoration:none;">{{ $loginUrl }}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td style="padding:8px 36px 0 36px;">
                            @foreach ($sections as $section)
                                <p style="margin:0 0 10px 0; font-size:14px; line-height:1.7; color:#101820;">
                                    <span style="color:#192a77; font-weight:700; margin-right:4px;">&gt;</span>
                                    <a href="{{ $baseUrl . $section['path'] }}" target="_blank" style="color:#192a77; text-decoration:none; font-weight:700;">{{ $section['label'] }}:</a>
                                    {{ $section['desc'] }}
                                </p>
                            @endforeach
                        </td>
                    ...
                    <tr>
                        <td style="padding:24px 36px 0 36px;">
                            ...
                            <p style="margin:0 0 8px 0; font-size:14px; line-height:1.7; color:#101820;">
                                <span style="color:#192a77; font-weight:700; margin-right:4px;">-</span>
                                <span style="color:#192a77; font-weight:700;">5 puntos:</span> marcador exacto (acertar goles de ambos equipos).
                            </p>
                            <p style="margin:0 0 8px 0; font-size:14px; line-height:1.7; color:#101820;">
                                <span style="color:#192a77; font-weight:700; margin-right:4px;">-</span>
                                <span style="color:#192a77; font-weight:700;">4 puntos:</span> acertar al ganador y el marcador de uno de los equipos.
                            </p>
                            <p style="margin:0 0 8px 0; font-size:14px; line-height:1.7; color:#101820;">
                                <span style="color:#192a77; font-weight:700; margin-right:4px;">-</span>
                                <span style="color:#192a77; font-weight:700;">2 puntos:</span> acertar solo al ganador o el empate, sin acertar los goles.
                            </p>
                            <p style="margin:0 0 8px 0; font-size:14px; line-height:1.7; color:#101820;">
                                <span style="color:#192a77; font-weight:700; margin-right:4px;">-</span>
                                <span style="color:#192a77; font-weight:700;">1 punto:</span> acertar los goles de uno de los equipos sin acertar al ganador.
                            </p>
                        </td>
                    </tr>
