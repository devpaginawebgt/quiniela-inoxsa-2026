        ...
        <div class="relative flex-1">
            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:items-start gap-4 lg:gap-8 2xl:gap-12 mx-auto mb-8 lg:mb-12">
                ...
                <div class="flex flex-col items-center md:items-end shrink-0 my-6 md:my-0">
                    <span class="text-4xl font-kinesthesia uppercase text-complementary-secondary">
                        Mi posici&oacute;n
                    </span>
                    <span class="text-8xl lg:text-9xl font-black leading-none my-2 md:my-0">
                        {{ $user_rank ?? '-' }}
                    </span>
                    <a href="{{ route('web.users.ranking-general') }}" class="text-3xl font-kinesthesia text-complementary-dark">
            ...
            <div class="mx-auto rounded-t-3xl overflow-x-auto">
                <table class="w-full text-left text-dark">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-zinc-300 text-lg sm:text-2xl lg:text-3xl font-kinesthesia">
                        ...
                        @empty
                        <tr>
                            <td colspan="3" class="text-center text-zinc-400 py-20 text-lg sm:text-xl lg:text-2xl font-kinesthesia uppercase">
