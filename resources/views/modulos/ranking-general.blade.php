<x-app-layout>
    <div class="flex flex-col flex-1">
        ...
        <div class="relative flex-1">
            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:items-start gap-4 lg:gap-8 2xl:gap-12 mx-auto mb-8 lg:mb-12">
                <h1 class="text-center md:text-start text-5xl sm:text-7xl lg:text-8xl uppercase font-kinesthesia text-secondary">
                    Resultados de quiniela
                </h1>

                <div class="flex flex-col items-center md:items-end shrink-0 my-6 md:my-0">
                    <span class="text-4xl font-kinesthesia text-complementary-secondary uppercase">
                        Mi posici&oacute;n
                    </span>
                    <span class="text-8xl lg:text-9xl font-black leading-none my-2 md:my-0" data-user-rank="{{ $user_rank ?? '' }}">
                        {{ $user_rank ?? '-' }}
                    </span>
                    <a href="{{ route('web.users.tabla-de-resultados') }}" class="text-3xl font-kinesthesia text-complementary-dark">
                        Ver top 10
                    </a>
                </div>
            </div>
            ...
            {{-- Subtitulo --}}
            <h2 class="text-2xl sm:text-3xl lg:text-4xl uppercase font-kinesthesia mb-2 mx-auto">
                Mi Posición
            </h2>
            ...
            >
                ...
                {{-- Mensaje vacío --}}
                <p id="ranking-empty" class="hidden text-center text-zinc-400 py-20 text-lg sm:text-xl lg:text-2xl font-kinesthesia uppercase">
                ...
                <div class="hidden" id="load-more-container">
                    <button
                        id="load-more-btn"
                        class="w-full py-4 bg-dark text-light font-kinesthesia text-xl uppercase hover:bg-zinc-600 transition-colors cursor-pointer rounded-b-3xl"
                    >
                        Cargar m&aacute;s
                    </button>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function createRow(user) {
            ...
            tr.className = 'border-b border-zinc-300 text-lg sm:text-2xl lg:text-3xl font-kinesthesia';
